...
<div class="glass-container background-glass">
    <h3>Create Teacher Time Table</h3>
    <div class="teacher_time_table">
        <form class="teacher_time_table" action="../PHP/teacher_time_table.php" method="post">

            <label for="username">Enter The Teacher Username: </label>
            <input id="username" name="username" type="text"><br><br>

            <button type="submit" name="create_time_table" value="create">Create Time Table</button>
            <button type="submit" name="preview_time_table" value="preview">Preview Time Table</button>
        </form>
    </div>
    <br>
    <br>

    <h3>Add Time Table Data</h3>
    <div class="teacher_time_table">
        <form class="teacher_time_table" action="../PHP/teacher_time_table.php" method="post">
            ...
            <label for="class_day">Enter the day of the Class</label>
            <input id="class_day" name="class_day" type="text" placeholder="YYYY-MM-DD"><br><br>

            <label for="start_time">Enter Start Time</label>
            <input id="start_time" name="start_time" type="text" placeholder="HH:MM:SS"><br><br>

            <label for="end_time">Enter End Time</label>
            <input id="end_time" name="end_time" type="text" placeholder="HH:MM:SS"><br><br>
